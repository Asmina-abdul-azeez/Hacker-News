...
part of '../../presentation/profile_page/profile_page_state.dart';
...
class _$ProfilePageStateImpl implements _ProfilePageState {
  const _$ProfilePageStateImpl({this.phoneNumber});

  factory _$ProfilePageStateImpl.fromJson(Map<String, dynamic> json) =>
      _$$ProfilePageStateImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ProfilePageState(phoneNumber: $phoneNumber)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$ProfilePageStateImplToJson(
      this,
    );
  }
}
...
abstract class _ProfilePageState implements ProfilePageState {
  const factory _ProfilePageState({final String? phoneNumber}) =
      _$ProfilePageStateImpl;

  factory _ProfilePageState.fromJson(Map<String, dynamic> json) =
      _$ProfilePageStateImpl.fromJson;
