...
part of '../../presentation/news/news_state.dart';
...
/// @nodoc
mixin _$NewsState {
  Resource<List<NewsHit>> get newsList => throw _privateConstructorUsedError;
...
abstract class $NewsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Resource<List<NewsHit>> newsList});
}
...
class _$NewsStateImpl with DiagnosticableTreeMixin implements _NewsState {
  const _$NewsStateImpl({this.newsList = const ResourceInitial()});

  @override
  @JsonKey()
  final Resource<List<NewsHit>> newsList;
  ...
  @override
  int get hashCode => Object.hash(runtimeType, newsList);
...
abstract class _NewsState implements NewsState {
  const factory _NewsState({final Resource<List<NewsHit>> newsList}) =
      _$NewsStateImpl;

  @override
  Resource<List<NewsHit>> get newsList;
  @override
  @JsonKey(ignore: true)
  _$$NewsStateImplCopyWith<_$NewsStateImpl> get copyWith =>
      throw _privateConstructorUsedError;
